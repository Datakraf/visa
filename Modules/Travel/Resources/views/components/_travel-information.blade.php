            ...
            <div class="form-group">
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" class="form-control {{$errors->has('venue') ? 'is-invalid':''}}" name="venue"
                            value="{{old('venue',$application->venue ?? null)}}" placeholder="e.g: University of Cambridge">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control {{$errors->has('state') ? 'is-invalid':''}}" name="state"
                            value="{{old('state',$application->state ?? null)}}" placeholder="e.g: Cambridge">
            ...
            <div class="form-group">
                ...
                <select class="form-control " name="event_type" placeholder="">
                    ...
                    <option value="competition"
                        {{isset($application) && $application->event_type == 'competition' ? 'selected':null}}>Competition</option>
                    <option value="conference"
                        {{isset($application) && $application->event_type == 'conference' ? 'selected':null}}>Conference</option>
                    <option value="conventions"
                        {{isset($application)&& $application->event_type == 'conventions' ? 'selected':null}}>Conventions</option>
                    <option value="exhibitions"
                        {{isset($application) && $application->event_type == 'exhibitions' ? 'selected':null}}>Exhibitions</option>
                    <option value="fairs"
                        {{isset($application) && $application->event_type == 'fairs' ? 'selected':null}}>Fairs</option>
                    <option value="networking-events"
                        {{isset($application) && $application->event_type == 'networking-events' ? 'selected':null}}>Networking
                        Events</option>
                    <option value="seminars"
                        {{isset($application) && $application->event_type == 'seminars' ? 'selected':null}}>Seminars</option>
                    <option value="symposium"
                        {{isset($application) && $application->event_type == 'symposium' ? 'selected':null}}>Symposium</option>
                    <option value="workshop"
                        {{isset($application) && $application->event_type == 'workshop' ? 'selected':null}}>Workshop</option>
                </select>
